...
const Cards = ({icon,heading,about }) => {
  return (
    <div className="flex overflow-hidden flex-col justify-center w-full mx-auto rounded-lg shadow-md hover:scale-105 duration-300 hover:shadow-emerald-700 transition-all space-y-2 p-4 h-full">
